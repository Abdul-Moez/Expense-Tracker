        ...
        <tbody>
          ...
          @foreach ($bankAccountsList as $rsBankAccountsList)
              <tr>
                  ...
                  <td>{{ \App\ASPLibraries\CustomFunctions::decrypt( $rsBankAccountsList->account_name ) }}</td>
                  <td>{{ \App\ASPLibraries\CustomFunctions::decrypt( $rsBankAccountsList->account_type ) }}</td>
                  <td>{{ \App\ASPLibraries\CustomFunctions::decrypt( $rsBankAccountsList->account_number ) }}</td>
