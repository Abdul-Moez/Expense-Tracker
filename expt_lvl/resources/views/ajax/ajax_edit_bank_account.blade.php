...
<form action="javascript:void(0)">
    ...
    <div class="form-floating mb-3">
        <input class="form-control" type="text" id="update_bank_account_name" name="update_bank_account_name" value="{{ \App\ASPLibraries\CustomFunctions::decrypt( $bankAccountData->account_name ) }}" required>
        <label>Account Name <span class="text-danger">*</span></label>
    </div>
    <div class="form-floating mb-3">
        <?php $accountType = \App\ASPLibraries\CustomFunctions::decrypt( $bankAccountData->account_type ) ?>
    ...
    <div class="form-floating mb-3">
        <input class="form-control" type="text" id="update_bank_account_number" name="update_bank_account_number" value="{{ \App\ASPLibraries\CustomFunctions::decrypt( $bankAccountData->account_number ) }}" required>
