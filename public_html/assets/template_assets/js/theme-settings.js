!(function () {
      ...
      Array.from(a).forEach(function (a) {
        ...
        a.addEventListener("show.bs.collapse", function (c) {
          ...
          c
            ...
            : ((d = (function (b) {
                for (var c = [], a = b.parentNode.firstChild; a; )
                  1 === a.nodeType && a !== b && c.push(a), (a = a.nextSibling);
                return c;
              })(a.parentElement)),
              Array.from(d).forEach(function (a) {
                2 < a.childNodes.length &&
                  a.firstElementChild.setAttribute("aria-expanded", "false"),
            ...
            b.stopPropagation(),
              ...
              Array.from(b).forEach(function (a) {
                (childCollapseInstance =
                  bootstrap.Collapse.getInstance(a)).hide();
              });
          });
      }));
  }
  function t() {
    ...
    b &&
      ...
      ((c = document.createElement("ul")).innerHTML =
        '<a href="#" class="logo"><img src="{{ URL("assets/img/logo.png") }}" alt="" height="22"></a>'),
      Array.from(
        ...
        Array.from(a.querySelectorAll("span")).forEach(function (a) {
          ...
          b.parentElement.classList.contains("twocolumn-item-show") &&
      ...
      Array.from(
        ...
        var b = (b =
          "/" == location.pathname
            ? "index.html"
            : location.pathname.substring(1)).substring(b.lastIndexOf("/") + 1);
        a.addEventListener("click", function (c) {
          ...
          (b != "/" + a.getAttribute("href") ||
            ...
            ((c.target && c.target.matches("a.nav-icon")) ||
              ...
              0 <
                (d = document.getElementsByClassName("twocolumn-item-show"))
                  .length && d[0].classList.remove("twocolumn-item-show"),
              (c = (c.target.matches("i") ? c.target.closest("a") : c.target)
                .getAttribute("href")
                .slice(1)),
  ...
  function A(a) {
    if (a.target && a.target.matches("a.nav-link span")) {
      if (0 == u(a.target.parentElement.nextElementSibling)) {
        ...
        for (
          var b = document.getElementsByClassName("dropdown-custom-right");
          0 < b.length;
    ...
    if (a.target && a.target.matches("a.nav-link")) {
      if (0 == u(a.target.nextElementSibling))
        a.target.nextElementSibling.classList.add("dropdown-custom-right"),
          ...
          Array.from(c.querySelectorAll(".menu-dropdown")).forEach(function (
            a
          ) {
            a.classList.add("dropdown-custom-right");
          });
        ...
        for (
          b = document.getElementsByClassName("dropdown-custom-right");
          0 < b.length;
    ...
    (b = b.substring(b.lastIndexOf("/") + 1)) &&
      ...
      (c = document
        ...
        ? (c.classList.add("active"),
          (a =
            (a = c.closest(".collapse.menu-dropdown")) &&
            a.parentElement.closest(".collapse.menu-dropdown")
              ? (a.classList.add("show"),
                a.parentElement.children[0].classList.add("active"),
                a.parentElement
            ...
            a.parentElement.parentElement.parentElement.parentElement.closest(
              ...
              a.parentElement.parentElement.parentElement.parentElement.closest(
                ...
                "horizontal" ==
                  ...
                  a.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.closest(
                    ".collapse"
                  ) &&
                  a.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement
                    .closest(".collapse")
                    .previousElementSibling.classList.add("active")))))));
  }
  function u(a) {
    ...
    if (a == a) {
      ...
      switch (a["data-layout-mode"]) {
        ...
        case "dark":
          ...
          break;
        case "blue":
          G("data-layout-mode", "blue"),
            document.documentElement.setAttribute("data-layout-mode", "blue"),
            sessionStorage.setItem("data-layout-mode", "blue");
          break;
        case "marron":
          G("data-layout-mode", "maroon"),
            document.documentElement.setAttribute("data-layout-mode", "maroon"),
            sessionStorage.setItem("data-layout-mode", "maroon");
          break;
        case "purple":
          G("data-layout-mode", "purple"),
            document.documentElement.setAttribute("data-layout-mode", "purple"),
            sessionStorage.setItem("data-layout-mode", "purple");
          break;
        default:
  ...
  function w() {
    setTimeout(function () {
      ...
      a &&
        300 <
          (c = (a = a.querySelector(".nav-item .active")) ? a.offsetTop : 0) &&
  ...
  sessionStorage.getItem("defaultAttribute")
    ? (((b = {})["data-layout"] = sessionStorage.getItem("data-layout")),
      ...
      (b["data-layout-position"] = sessionStorage.getItem(
        "data-layout-position"
      )),
    ...
    : ((a = document.documentElement.attributes),
      ...
      Array.from(a).forEach(function (a) {
        ...
        a &&
          a.nodeName &&
          "undefined" != a.nodeName &&
          ((b[(c = a.nodeName)] = a.nodeValue),
          sessionStorage.setItem(c, a.nodeValue));
      }),
          ...
          ? (o.classList.add("show"),
            ...
            Array.from(a).forEach(function (a) {
              var c = a.getElementsByTagName("span")
                ? a.getElementsByTagName("span")[0].innerText.toLowerCase()
                : "";
    ...
    g &&
      ...
      (d.addEventListener("focus", function () {
        0 < d.value.length
          ? (k.classList.add("show"), g.classList.remove("d-none"))
          : (k.classList.remove("show"), g.classList.add("d-none"));
      }),
    ...
    (a = document.querySelectorAll(".light-dark-mode")) &&
      ...
      a[0].addEventListener("click", function (a) {
        ...
        "dark" == p.getAttribute("data-layout-mode")
          ? H("data-layout-mode", "orange", "layout-mode-orange", p)
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      Array.from(a).forEach(function (a) {
        a.addEventListener("change", function () {
          ...
          a.checked
            ? (c.classList.add("d-none"), b.classList.remove("d-none"))
            : (c.classList.remove("d-none"), b.classList.add("d-none"));
        });
      });
    }),
      ...
      a &&
        Array.from(a).forEach(function (a) {
          !(function f() {
            ...
            d < 1 && (d = 1),
              e < c
                ? ((a.innerText = (e + d).toFixed(0)), setTimeout(f, 1))
                : (a.innerText = b(c)),
              b(a.innerText);
          })();
        });
      ...
      a.addEventListener("click", function () {
        ...
        c["data-toast-text"] &&
          ...
          c["data-toast-position"] &&
            (b.position = c["data-toast-position"].value.toString()),
          c["data-toast-className"] &&
            (b.className = c["data-toast-className"].value.toString()),
          c["data-toast-duration"] &&
            (b.duration = c["data-toast-duration"].value.toString()),
          c["data-toast-close"] &&
    ...
    Array.from(a).forEach(function (c) {
      ...
      a["data-choices-groups"] &&
        (b.placeholderValue = "This is a placeholder set in the config"),
    ...
    Array.from(a).forEach(function (d) {
      ...
      "flatpickr" == d.getAttribute("data-provider")
        ? ((a = {}),
          ...
          c["data-enable-time"] &&
            ((a.enableTime = !0),
            (a.dateFormat = c["data-date-format"].value.toString() + " H:i")),
          c["data-altFormat"] &&
            ((a.altInput = !0),
        ...
        : "timepickr" == d.getAttribute("data-provider") &&
          ...
          (a = d.attributes)["data-time-basic"] &&
            ((b.enableTime = !0), (b.noCalendar = !0), (b.dateFormat = "H:i")),
          a["data-time-hrs"] &&
            ((b.enableTime = !0),
            (b.noCalendar = !0),
            (b.dateFormat = "H:i"),
          ...
          a["data-default-time"] &&
            ...
            (b.noCalendar = !0),
            (b.dateFormat = "H:i"),
            (b.defaultDate = a["data-default-time"].value.toString())),
          a["data-time-inline"] &&
            ((b.enableTime = !0),
            (b.noCalendar = !0),
